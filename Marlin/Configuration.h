...
#define STRING_CONFIG_H_AUTHOR "(Exlinetr, custom config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Exlinetr Ender 3 V2 3D Printer"
...
#define POWER_LOSS_RECOVERY true